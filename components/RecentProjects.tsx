...
const RecentProjects = ({ projects, messages }: RecentProjectsProps) => {
    return (
        <div className='py-20' id='projects'>
            <h1 className='heading'>
                {messages.projectsGeneral.title} {' '}
                <span className='text-guerrero-red'>{messages.projectsGeneral.titleHighlight}</span>
            </h1>
                            ...
                            <div className='flex items-center justify-between mt-7 mb-3 '>
                                <div className='flex items-center'>
                                    {iconLists.map((icon: string, index: number) => (
                                        <div
                                            key={icon}
                                            className=' border border-white/[0.2] rounded-full bg-guerrero-red lg:w-10 lg:h-10 w-8 h-8 flex justify-center items-center'
                                ...
                                <div className='flex justify-center items-center'>
                                    <p className='flex lg:text-lg md:text-xs text-sm text-guerrero-red'>
                                        {messages.projectsGeneral.button}
                                    </p>
                                    <FaLocationArrow className='ms-3' color='#8B2626' />
                                </div>
                            </div>
                        </PinContainer>
                    </div>
